...
import {
  Users, Search, Shield, Mail, Phone, MapPin, Calendar, ArrowLeft,
} from "lucide-react";
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center gap-2 text-sm">
                <Mail className="h-4 w-4 text-muted-foreground" /> {selectedUser.email}
              </div>
              <div className="flex items-center gap-2 text-sm">
                <Phone className="h-4 w-4 text-muted-foreground" /> {selectedUser.phone}
              </div>
              <div className="flex items-center gap-2 text-sm">
                <MapPin className="h-4 w-4 text-muted-foreground" /> {selectedUser.address}, {selectedUser.city}, {selectedUser.country}
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center gap-2 text-sm">
                ...
                {selectedUser.dateOfBirth} {age !== null && <span className="text-muted-foreground">({age} {t("سنة", "yrs")})</span>}
              </div>
              ...
              <div className="text-sm">
                ...
                <p>{selectedUser.lastLogin || t("لم يسجل دخول", "Never")}</p>
              </div>
            </CardContent>
          </Card>
        </div>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>{t("المصادقة الثنائية", "2FA")}</TableHead>
